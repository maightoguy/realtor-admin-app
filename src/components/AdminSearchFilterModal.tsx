...
interface AdminSearchFilterModalProps {
  ...
  onReset?: () => void;
  // Allows us to configure the filter for different sections (Properties, Receipts, etc.)
  config?: {
    title?: string;
    description?: string;
...
const AdminSearchFilterModal: FC<AdminSearchFilterModalProps> = ({
  isOpen,
  onClose,
  initialFilters,
  onApply,
  ...
  config = {
    title: "Filter",
    description: "Set the Preference for the type of content you want to see",
    ...
    >
      ...
      >
        ...
        <div className="relative border-b border-[#F0F1F2] px-6 pt-6 pb-4 bg-white">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-[14px] text-[#6B7280]">
              {config.description || "Set your filter preferences"}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-grow p-6 flex flex-col gap-6 font-poppins">
          ...
          {/* Active Price Preview (Optional - keeping it to match webapp) */}
          {config.showPrice && (
            <div className="flex flex-col gap-2">
...
export default AdminSearchFilterModal;
