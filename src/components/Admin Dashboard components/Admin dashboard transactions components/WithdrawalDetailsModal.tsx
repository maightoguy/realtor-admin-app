...
const WithdrawalDetailsModal = ({
  ...
  const handleConfirmReject = async () => {
    ...
    try {
      setIsSubmitting(true);
      await onReject(transaction.id, reason);
      onClose();
    } catch (err) {
          ...
          <div className="p-6 border-b border-[#F0F1F2]">
            <div className="flex flex-col items-start gap-4">
              <div className="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center shrink-0">
                ...
                >
                  <g clipPath="url(#clip0_19885_8481)">
                    <path
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  This contains the details of this requesr
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="border border-[#F0F1F2] bg-[#FAFAFA] rounded-xl p-4 space-y-3">
                ...
                <DetailRow
                  label="Bank name"
                  value={transaction.bankName || "N/A"}
                />
                <DetailRow
                ...
                <DetailRow
                  ...
                  value={transaction.accountBalance || "N/A"}
                />
                ...
                {isRejecting ? (
                  <div className="space-y-3">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full border border-[#F0F1F2] rounded-lg p-3 text-sm outline-none focus:ring-2 focus:ring-[#6500AC]/20 focus:border-[#6500AC]"
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className="flex-1 px-4 py-3 border border-[#F0F1F2] rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50"
                        disabled={isSubmitting}
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="flex-1 px-4 py-3 bg-[#EF4444] text-white rounded-lg text-sm font-medium hover:bg-[#DC2626] transition-colors disabled:opacity-50"
                        disabled={isSubmitting}
                      >
                        Confirm reject
                      </button>
